...
- Evaluating Load Factor % trends against total passenger volume to identify demand fluctuations
- Comparing carrier performance across freight, payload, and operational efficiency metrics
- Analyzing route-level traffic concentration to detect high-yield corridors
- Assessing weekday vs weekend performance variability
